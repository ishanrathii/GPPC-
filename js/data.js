/* ============================================================
   Default content for Gurunisa Prabha Prakash Chaitanya
   Editable from admin.html — admin saves overrides to
   localStorage under the GPPC_* keys, which the site reads first.
   ============================================================ */
window.GPPC_DEFAULTS = {
  ...
  teachings: [
    ...
    {title:"Foundations of Spirituality", topic:"Spirituality", type:"Video", icon:"📿", excerpt:"An introductory talk on the timeless principles that guide the spiritual path."},
    {title:"Grace in Manners", topic:"Manners", type:"Article", icon:"🙏", excerpt:"Why humility, courtesy and respect are the outward fragrance of an inner virtue."},
    {title:"Building an Unshakeable Personality", topic:"Personality", type:"Video", icon:"✨", excerpt:"Practical wisdom for cultivating confidence rooted in values."},
    {title:"Guidance for Today's Youth", topic:"Youth", type:"Article", icon:"🌟", excerpt:"Navigating modern pressures with clarity, discipline and spiritual strength."},
    {title:"The Practice of Meditation", topic:"Meditation", type:"Video", icon:"🧘", excerpt:"A guided introduction to stilling the mind and resting in awareness."},
    {title:"The Power of Positive Living", topic:"Positive Living", type:"Article", icon:"☀️", excerpt:"Transform your outlook with gratitude, kindness and mindful habits."}
  ],

  quotes: [
    {text:"The mind is everything. What you think, you become.", author:"Lord Mahavira"},
    {text:"Live and let live — non-violence is the highest religion.", author:"Jain Wisdom"},
    {text:"Peace comes from within. Do not seek it without.", author:"Ancient Teaching"},
    {text:"A single candle can light a thousand without losing its glow.", author:"Spiritual Proverb"},
    {text:"He who conquers himself is the greatest of all victors.", author:"Sacred Saying"},
    {text:"Where there is compassion, there is divinity.", author:"Guru Vani"},
    {text:"Silence is the language in which the soul speaks to itself.", author:"Meditation Wisdom"}
  ],

  gallery: [
    {icon:"🪔", cap:"Evening Aarti Gathering", tall:true},
    {icon:"📿", cap:"Morning Discourse"},
